...
type MessageRequest struct {
	...
	Email   string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`     // The user's email address to send him an email.
	Subject string `protobuf:"bytes,2,opt,name=subject,proto3" json:"subject,omitempty"` // Email subject.
	Body    string `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`       // Email body.
}
...
func (x *MessageRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
type StatusResponse struct {
	...
	Status string `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // Indicates whether a message has been sent.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x0c, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x54, 0x0a,
	...
	0x6f, 0x64, 0x79, 0x22, 0x28, 0x0a, 0x0e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x62, 0x0a,
	0x0c, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x52, 0x0a,
	0x14, 0x54, 0x65, 0x6c, 0x65, 0x67, 0x72, 0x61, 0x6d, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1c, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
	0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x65, 0x42, 0x14, 0x5a, 0x12, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
...
var file_sso_sso_proto_goTypes = []any{
	(*MessageRequest)(nil), // 0: notification.MessageRequest
	(*StatusResponse)(nil), // 1: notification.StatusResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: notification.Notification.TelegramNotification:input_type -> notification.MessageRequest
	1, // 1: notification.Notification.TelegramNotification:output_type -> notification.StatusResponse
